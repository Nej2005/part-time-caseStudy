...
<body>
            ...
            <div class="container">
                <div class="header-content">
                    <div class="logo-container">
                        <button class="back-button" onclick="window.location.href='emp-dtr.php'">←</button>
    ...
    <script>
        ...
        function confirmDelete() {
            const dtrId = document.getElementById('dateFrom').dataset.dtrId;

            if (!dtrId) {
                alert('No DTR record found to delete');
                return;
            }

            if (confirm('Are you sure you want to delete this time record? This action cannot be undone.')) {
                fetch('../Backend/DTR/delete_dtr.php', {
                        method: 'POST',
                        headers: {
        ...
        async function fetchDTRData(year, month, professorId) {
            try {
                // Show loading state
        ...
        function handleYearMonthChange() {
            ...
            if (selectedYear && selectedMonth) {
                ...
                // Then fetch the data
                fetchDTRData(selectedYear, selectedMonth, professorId);
            }
        }
